...
function lista() {
	...
	$out.='<thead>';
	$out.='<tr><td><a href="echo $_SERVER['PHP_SELF']?azione=form">Inserisci nuovo</a></td></tr>';
	...
	while($row = $result->fetch_array(MYSQLI_ASSOC)){
		...
		$out.='<td>'.$row['email'].'</td>';
		$out.='<td><a href="echo $_SERVER['PHP_SELF']?azione=dettaglio&id='.$row['id'].'"><span class="glyphicon glyphicon-zoom-in"></span></a></td>';
		$out.='<td><a href="echo $_SERVER['PHP_SELF']?azione=form&id='.$row['id'].'"><span class="glyphicon glyphicon-pencil"></span></a></td>';
		$out.='<td><a href="echo $_SERVER['PHP_SELF']?azione=elimina&id='.$row['id'].'"><span class="glyphicon glyphicon-remove"></span></a></td>';
		$out.='</tr>';
		}
	...
	{
	$out .='<li><a href="echo $_SERVER['PHP_SELF']?page='.$i.'">'.$i.'</a></li>';
	}
	$out .= "</ul></nav></td></tr>";
	 $out.='</table>';
return($out);
...
function form() {
	...
	$out='';
	$out.='<form name="info" action="echo $_SERVER['PHP_SELF']" method="post">';
